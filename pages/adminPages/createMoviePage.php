...
<html lang="es">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            if (isset($_GET['corr'])) {
                echo '<div class="message message-correct"><p class="message__text">Película creada correctamente.</p></div>';
            }
            if (isset($_GET['err'])) {
                echo '<div class="message message-error"><p class="message__text">Ha habído un error en la creación.</p></div>';
            }
            ?>
            <h1>Bienvenido <?= $user->getUsername() ?></h1>

            <form class="form d-flex flex-column align-items-center w-25 m-auto mt-5" action="../../lib/controllers/adminController/createMovie.php" method="POST">
                <h2 class="form__subtitle">AÑADIR PELÍCULA</h2>
                ...
                <div class="d-flex flex-column form__inputs">  
                    <input class="form__input form__inputs--pink" type="number" name="anyo" value="<?php echo is_numeric($anyoInt) ? $anyoInt : ''; ?>">
                    <label class="form__label">AÑO</label>
                </div>

                <div class="d-flex flex-column form__inputs">  
                    <input class="form__input form__inputs--blue" type="text" name="cartel" value="<?php if (isset($_GET['cartel'])) {echo $_GET['cartel'];} ?>">
                    <label class="form__label">CARTEL</label>
                </div>

                <input class="form__submit" type="submit" name="submit" value="Crear">
            </form>
